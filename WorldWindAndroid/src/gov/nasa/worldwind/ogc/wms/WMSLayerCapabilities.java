...
public class WMSLayerCapabilities extends AbstractXMLEventParser {
	...
	public XMLEventParser allocate(XMLEventParserContext ctx, XMLEvent event) {
		...
		if (ctx.isStartElement(event, LAYER)) defaultParser = new WMSLayerCapabilities(this.getNamespaceURI());
		else if (ctx.isStartElement(event, STYLE)) defaultParser = new WMSLayerStyle(this.getNamespaceURI());
		else if (ctx.isStartElement(event, KEYWORD_LIST)) defaultParser = new StringSetXMLEventParser(this.getNamespaceURI(), KEYWORD);
		else if (ctx.isStartElement(event, BOUNDING_BOX)) defaultParser = new OGCBoundingBox(this.getNamespaceURI());
		else if (ctx.isStartElement(event, ATTRIBUTION)) defaultParser = new WMSLayerAttribution(this.getNamespaceURI());
		else if (ctx.isStartElement(event, IDENTIFIER)) defaultParser = new WMSLayerIdentifier(this.getNamespaceURI());
		else if (ctx.isStartElement(event, DIMENSION)) defaultParser = new WMSLayerDimension(this.getNamespaceURI());
		else if (ctx.isStartElement(event, EXTENT)) defaultParser = new WMSLayerExtent(this.getNamespaceURI());
		else if (ctx.isStartElement(event, AUTHORITY_URL)) defaultParser = new WMSAuthorityURL(this.getNamespaceURI());
		else if (ctx.isStartElement(event, DATA_URL)) defaultParser = new WMSLayerInfoURL(this.getNamespaceURI());
		else if (ctx.isStartElement(event, FEATURE_LIST_URL)) defaultParser = new WMSLayerInfoURL(this.getNamespaceURI());
		else if (ctx.isStartElement(event, METADATA_URL)) defaultParser = new WMSLayerInfoURL(this.getNamespaceURI());
	...
	public void resolveAttributes(WMSLayerCapabilities parentLayer) {
		...
		if (this.getCascaded() == null) this.setCascaded(this.parent != null ? this.parent.getCascaded() : false);

		if (this.queryable == null) this.setQueryable(this.parent != null ? this.parent.isQueryable() : false);

		if (this.noSubsets == null) this.setNoSubsets(this.parent != null ? this.parent.isNoSubsets() : false);

		if (this.opaque == null) this.setOpaque(this.parent != null ? this.parent.isOpaque() : false);

		if (this.getFixedWidth() == null) this.setFixedWidth(this.parent != null ? this.parent.getFixedWidth() : 0);

		if (this.getFixedHeight() == null) this.setFixedHeight(this.parent != null ? this.parent.getFixedHeight() : 0);
	...
	protected void doParseEventContent(XMLEventParserContext ctx, XMLEvent event, Object... args) throws XMLParserException {
		if (ctx.isStartElement(event, LAYER)) {
			...
			if (parser != null) {
				...
				if (o != null && o instanceof WMSLayerCapabilities) this.addLayer(((WMSLayerCapabilities) o));
			}
		} else if (ctx.isStartElement(event, TITLE)) {
			String s = ctx.getStringParser().parseString(ctx, event);
			if (!WWUtil.isEmpty(s)) this.setTitle(s);
		} else if (ctx.isStartElement(event, NAME)) {
			String s = ctx.getStringParser().parseString(ctx, event);
			if (!WWUtil.isEmpty(s)) this.setName(s);
		} else if (ctx.isStartElement(event, STYLE)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerStyle) this.addStyle(((WMSLayerStyle) o));
			}
		} else if (ctx.isStartElement(event, SRS)) {
			String s = ctx.getStringParser().parseString(ctx, event);
			if (!WWUtil.isEmpty(s)) this.addSRS(s);
		} else if (ctx.isStartElement(event, CRS)) {
			String s = ctx.getStringParser().parseString(ctx, event);
			if (!WWUtil.isEmpty(s)) this.addCRS(s);
			...
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof OGCBoundingBox) this.addBoundingBox((OGCBoundingBox) o);
			}
		} else if (ctx.isStartElement(event, ATTRIBUTION)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerAttribution) this.addAttribution((WMSLayerAttribution) o);
			}
			...
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerIdentifier) this.addIdentifer((WMSLayerIdentifier) o);
			}
		} else if (ctx.isStartElement(event, DIMENSION)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerDimension) this.addDimension((WMSLayerDimension) o);
			}
		} else if (ctx.isStartElement(event, EXTENT)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerExtent) this.addExtent((WMSLayerExtent) o);
			}
		} else if (ctx.isStartElement(event, AUTHORITY_URL)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSAuthorityURL) this.addAuthorityURL((WMSAuthorityURL) o);
			}
		} else if (ctx.isStartElement(event, DATA_URL)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerInfoURL) this.addDataURL((WMSLayerInfoURL) o);
			}
		} else if (ctx.isStartElement(event, FEATURE_LIST_URL)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerInfoURL) this.addFeatureListURL((WMSLayerInfoURL) o);
			}
		} else if (ctx.isStartElement(event, METADATA_URL)) {
			XMLEventParser parser = this.allocate(ctx, event);
			if (parser != null) {
				Object o = parser.parse(ctx, event, args);
				if (o != null && o instanceof WMSLayerInfoURL) this.addMetadataURL((WMSLayerInfoURL) o);
			}
		}
	}

	protected void doParseEventAttributes(XMLEventParserContext ctx, XMLEvent layerEvent, Object... args) {
		AVList attrAvList = layerEvent.getAttributes();
		...
		for (Entry<String, Object> entry : avListEntries) {
			if (entry.getKey().equals("queryable") && entry.getValue() != null) {
				Boolean b = this.parseBooleanLayerAttribute(entry.getValue().toString());
				if (b != null) this.setQueryable(b);
			} else if (entry.getKey().equals("cascaded") && entry.getValue() != null) {
				Boolean b = this.parseBooleanLayerAttribute(entry.getValue().toString());
				if (b != null) this.setCascaded(b);
			} else if (entry.getKey().equals("opaque") && entry.getValue() != null) {
				Boolean b = this.parseBooleanLayerAttribute(entry.getValue().toString());
				if (b != null) this.setOpaque(b);
			} else if (entry.getKey().equals("noSubsets") && entry.getValue() != null) {
				Boolean b = this.parseBooleanLayerAttribute(entry.getValue().toString());
				if (b != null) this.setNoSubsets(b);
			} else if (entry.getKey().equals("fixedWidth") && entry.getValue() != null) {
				Double d = WWUtil.convertStringToDouble(entry.getValue().toString());
				if (d != null) this.setFixedWidth(d.intValue());
			} else if (entry.getKey().equals("fixedHeight") && entry.getValue() != null) {
				Double d = WWUtil.convertStringToDouble(entry.getValue().toString());
				if (d != null) this.setFixedHeight(d.intValue());
			}
		}
		// while (iter.hasNext()) {
	...
	protected Boolean parseBooleanLayerAttribute(String s) {
		if (WWUtil.isEmpty(s)) return false;
	...
	protected void parseExtremeElevations(XMLEventParserContext ctx, XMLEvent layerEvent) {
		...
		Set<Entry<String, Object>> avListEntries = attrAvList.getEntries();
		for (Entry<String, Object> entry : avListEntries) {
			if (entry.getKey().equals("min") && entry.getValue() != null) {
				Double d = WWUtil.convertStringToDouble(entry.getValue().toString());
				if (d != null) this.setExtremeElevationMin(d);
			} else if (entry.getKey().equals("max") && entry.getValue() != null) {
				Double d = WWUtil.convertStringToDouble(entry.getValue().toString());
				if (d != null) this.setExtremeElevationMax(d);
			}
		}
		// while (iter.hasNext()) {
		// Attribute attr = (Attribute) iter.next();
	...
	protected void parseGeographicBoundingBox(XMLEventParserContext ctx, XMLEvent bboxEvent) throws XMLParserException {
		Double minLat = null;
		Double minLon = null;
		Double maxLat = null;
		Double maxLon = null;
		...
		for (XMLEvent event = ctx.nextEvent(); event != null; event = ctx.nextEvent()) {
			if (ctx.isEndElement(event, bboxEvent)) {
				if (minLat != null && minLon != null && maxLat != null && maxLon != null) this.setGeographicBoundingBox(Sector.fromDegrees(minLat, maxLat, minLon, maxLon));
				return;
			} else if (event.isStartElement()) {
				if (event.getName().getLocalPart().equals("westBoundLongitude")) {
					Double d = ctx.getDoubleParser().parseDouble(ctx, event);
					if (d != null) minLon = d;
				} else if (event.getName().getLocalPart().equals("eastBoundLongitude")) {
					Double d = ctx.getDoubleParser().parseDouble(ctx, event);
					if (d != null) maxLon = d;
				} else if (event.getName().getLocalPart().equals("southBoundLatitude")) {
					Double d = ctx.getDoubleParser().parseDouble(ctx, event);
					if (d != null) minLat = d;
				} else if (event.getName().getLocalPart().equals("northBoundLatitude")) {
					Double d = ctx.getDoubleParser().parseDouble(ctx, event);
					if (d != null) maxLat = d;
				}
			}
	...
	protected void parseGeographicBoundingBoxV111(XMLEventParserContext ctx, XMLEvent bboxEvent) throws XMLParserException {
		Double minLat = null;
		Double minLon = null;
		Double maxLat = null;
		Double maxLon = null;
		AVList attrAvList = bboxEvent.getAttributes();
		if (null == attrAvList || attrAvList.getEntries().isEmpty()) return;
		// Iterator iter = bboxEvent.asStartElement().getAttributes();
		// if (iter == null) return;
		Set<Entry<String, Object>> avListEntries = attrAvList.getEntries();
		for (Entry<String, Object> entry : avListEntries) {
			if (entry.getKey().equals("minx") && entry.getValue() != null) {
				Double d = WWUtil.convertStringToDouble(entry.getValue().toString());
				if (d != null) minLon = d;
	...
	protected void parseScaleHint(XMLEventParserContext ctx, XMLEvent bboxEvent) throws XMLParserException {
		AVList attrAvList = bboxEvent.getAttributes();
		if (null == attrAvList || attrAvList.getEntries().isEmpty()) return;
		// Iterator iter = bboxEvent.asStartElement().getAttributes();
		// if (iter == null) return;
		...
		for (Entry<String, Object> entry : avListEntries) {
			if (entry.getKey().equals("min") && entry.getValue() != null) {
				Double d = WWUtil.convertStringToDouble(entry.getValue().toString());
				if (d != null) this.setMinScaleHint(d);
			} else if (entry.getKey().equals("max") && entry.getValue() != null) {
				Double d = WWUtil.convertStringToDouble(entry.getValue().toString());
				if (d != null) this.setMaxScaleHint(d);
			}
		}
		// while (iter.hasNext()) {
		// Attribute attr = (Attribute) iter.next();
	...
	public List<WMSLayerCapabilities> getNamedLayers() {
		...
		if (this.getName() != null) namedLayers.add(this);
	...
	public WMSLayerCapabilities getLayerByName(String name) {
		...
		if (this.getName() != null && this.getName().equals(name)) return this;

		for (WMSLayerCapabilities lc : this.getLayers()) {
			if (lc.getName() != null && lc.getName().equals(name)) return lc;
		}
	...
	protected void addDimension(WMSLayerDimension dimension) {
		if (this.dimensions == null) this.dimensions = new HashSet<WMSLayerDimension>();
	...
	public Set<WMSLayerExtent> getExtents() {
		if (this.extents != null) return this.extents;
		else return Collections.emptySet();
	}

	protected void addExtent(WMSLayerExtent extent) {
		if (this.extents == null) this.extents = new HashSet<WMSLayerExtent>();

		this.getExtents().add(extent);
	}

	protected void addExtents(Set<WMSLayerExtent> inExtents) {
		if (inExtents.size() == 0) return;
	...
	public Set<WMSLayerAttribution> getAttributions() {
		if (this.attributions != null) return attributions;
		else return Collections.emptySet();
	}
	...
	protected void addAttribution(WMSLayerAttribution attribution) {
		if (this.attributions == null) this.attributions = new HashSet<WMSLayerAttribution>();
	...
	public Set<WMSAuthorityURL> getAuthorityURLs() {
		if (this.authorityURLs != null) return this.authorityURLs;
		else return Collections.emptySet();
	}
	...
	protected void addAuthorityURL(WMSAuthorityURL authorityURL) {
		if (this.authorityURLs == null) this.authorityURLs = new HashSet<WMSAuthorityURL>();
	...
	public Set<WMSLayerIdentifier> getIdentifiers() {
		if (this.identifiers != null) return this.identifiers;
		else return Collections.emptySet();
	}

	protected void addIdentifer(WMSLayerIdentifier identifier) {
		if (this.identifiers == null) this.identifiers = new HashSet<WMSLayerIdentifier>();
	...
	public Set<WMSLayerInfoURL> getMetadataURLs() {
		if (this.metadataURLs != null) return this.metadataURLs;
		else return Collections.emptySet();
	}

	protected void addMetadataURL(WMSLayerInfoURL url) {
		if (this.metadataURLs == null) this.metadataURLs = new HashSet<WMSLayerInfoURL>();
	...
	public Set<WMSLayerInfoURL> getFeatureListURLs() {
		if (this.featureListURLs != null) return this.featureListURLs;
		else return Collections.emptySet();
	}

	protected void addFeatureListURL(WMSLayerInfoURL url) {
		if (this.featureListURLs == null) this.featureListURLs = new HashSet<WMSLayerInfoURL>();
	...
	public Set<WMSLayerInfoURL> getDataURLs() {
		if (this.dataURLs != null) return this.dataURLs;
		else return Collections.emptySet();
	}

	protected void addDataURL(WMSLayerInfoURL url) {
		if (this.dataURLs == null) this.dataURLs = new HashSet<WMSLayerInfoURL>();
	...
	protected void addLayer(WMSLayerCapabilities layer) {
		if (this.layers == null) this.layers = new ArrayList<WMSLayerCapabilities>();
	...
	protected void addStyle(WMSLayerStyle style) {
		if (this.styles == null) this.styles = new HashSet<WMSLayerStyle>();
	...
	public Set<OGCBoundingBox> getBoundingBoxes() {
		if (this.boundingBoxes != null) return this.boundingBoxes;
		else return Collections.emptySet();
	}
	...
	protected void addBoundingBox(OGCBoundingBox box) {
		if (this.boundingBoxes == null) this.boundingBoxes = new HashSet<OGCBoundingBox>();
	...
	public Set<String> getSRS() {
		if (this.srs != null) return this.srs;
		else return Collections.emptySet();
	}
	...
	protected void addSRS(String srs) {
		if (this.srs == null) this.srs = new HashSet<String>();
	...
	public Set<String> getCRS() {
		if (this.crs != null) return this.crs;
		else return Collections.emptySet();
	}
	...
	protected void addCRS(String crs) {
		if (this.crs == null) this.crs = new HashSet<String>();
	...
	public String toString() // TODO: Complete this method
	{
		...
		if (!WWUtil.isEmpty(this.getName())) sb.append(this.getName()).append(": ");
