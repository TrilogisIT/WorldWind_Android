 ...
 * @version $Id: OGCConstants.java 733 2012-09-02 17:15:09Z dcollins $
 */
public class OGCConstants {

	/**
	 * The name of the OGC Web Service <code>GetCapabilities</code> operation. The <code>GetCapabilities</code> operation returns metadata about the operations
	 * and data provided by an OGC Web Service. <code>GetCapabilities</code> is valid value for the <code>request</code> parameter. Used by all versions of all
	 * OGC web services.
	 */
	 ...
	 * OGC Web Service protocol to use. The version must be formatted as <code>x.y.z</code>, where <code>x, y</code> and <code>z</code> are integers in the
	 * range 0-99. Used by all versions of all OGC web services.
	 */
