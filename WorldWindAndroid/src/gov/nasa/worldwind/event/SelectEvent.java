...
public class SelectEvent extends WWEvent
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1852195882684083175L;
    ...
    public SelectEvent(Object source, String eventAction, Rect pickRectangle, PickedObjectList pickedObjects)
    {
        super(source);
        this.eventAction = eventAction;
        this.pickPoint = null;
