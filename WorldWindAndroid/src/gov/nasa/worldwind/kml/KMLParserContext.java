...
/**
 * The parser context for KML and KMZ documents. Specifies the classes used to parse each type of KML element.
 *
 * @author tag
 * @version $Id: KMLParserContext.java 822 2012-09-28 03:16:15Z dcollins $
 */
public class KMLParserContext extends BasicXMLEventParserContext
{
     ...
     *
     * @param defaultNamespace the default namespace. If null, {@link gov.nasa.worldwind.kml.KMLConstants#KML_NAMESPACE}
     *                         is used.
     */
