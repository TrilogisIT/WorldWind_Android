...
import gov.nasa.worldwind.kml.io.*;
 ...
 * are given in the Description section of {@link gov.nasa.worldwind.kml}.
 *
 * @author tag
 * @version $Id: KMLRoot.java 771 2012-09-14 19:30:10Z tgaskins $
 */
public class KMLRoot extends KMLAbstractObject implements KMLRenderable
{
    ...
    /**
     * Creates a KML root for an untyped source. The source must be either a {@link java.io.File}, a {@link
     * java.net.URL}, a {@link InputStream}, or a {@link String} identifying either a file path or a URL. For all types
     * other than <code>InputStream</code> an attempt is made to determine whether the source is KML or KMZ; KML is
     * assumed if the test is not definitive. Null is returned if the source type is not recognized.
     *
     * @param docSource either a {@link java.io.File}, a {@link java.net.URL}, or an {@link InputStream}, or a {@link
     *                  String} identifying a file path or URL.
     *
    ...
    /**
     * Creates a KML root for an untyped source. The source must be either a {@link File}, a {@link java.net.URL}, a
     * {@link InputStream}, or a {@link String} identifying either a file path or a URL. For all types other than
     ...
     *
     * @param docSource      either a {@link File}, a {@link java.net.URL}, or an {@link InputStream}, or a {@link
     *                       String} identifying a file path or URL.
     ...
     * @throws IllegalArgumentException if the source is null.
     * @throws IOException              if an error occurs while reading the source.
     * @throws XMLParserException       if the KML file has severe errors.
     */
    public static KMLRoot createAndParse(Object docSource) throws IOException, XMLParserException
    {
     ...
     * gov.nasa.worldwind.kml.KMLConstants#KML_NAMESPACE}).
     *
     ...
     *
     * @param docSource      the document source to create a reader for.
     * @param namespaceAware specifies whether to use a namespace-aware XML parser. <code>true</code> if so,
     *                       <code>false</code> if not.
     *
     ...
     * global {@link gov.nasa.worldwind.util.xml.XMLEventParserContextFactory}.
     *
...
//                o = this.resolveRemoteReference(path, linkRef, cacheRemoteFile);
     ...
     */
//    public Object resolveRemoteReference(String linkBase, String linkRef) // TODO
//    {
//        if (linkBase == null)
//        {
//            String message = Logging.getMessage("nullValue.DocumentSourceIsNull");
...
//    }
     ...
     * @throws IllegalArgumentException if the {@code linkBase} is null.
     */
//    public Object resolveRemoteReference(String linkBase, String linkRef, boolean cacheRemoteFile) // TODO
//    {
//        if (linkBase == null)
//        {
//            String message = Logging.getMessage("nullValue.DocumentSourceIsNull");
...
//    }
     ...
     */
//    public Object resolveNetworkLink(String link, boolean cacheRemoteFile, long updateTime) // TODO
//    {
//        if (link == null)
//        {
//            String message = Logging.getMessage("nullValue.DocumentSourceIsNull");
...
//    }
     ...
     */
//    public void evictIfExpired(String link, long expirationTime) // TODO
//    {
//        try
//        {
...
//    }
     ...
     *         not been retrieved.
     */
//    public long getExpiration(String link) // TODO
//    {
//        try
//        {
//            if (link == null)
...
//    }
     ...
     * @throws XMLParserException if a server parsing error is encountered.
     */
     ...
     *
     * @throws XMLParserException if an exception occurs while attempting to read the event stream.
     */
    public KMLRoot parse(Object... args) throws XMLParserException
    {
        ...
        try
        {
            ...
            while (event != null)
            {
                ...
                if (event.isStartElement() && event.getName().getLocalPart().equals("kml"))
                {
    ...
    /**
     * Returns the {@link gov.nasa.worldwind.kml.KMLNetworkLinkControl} element if the document root contains it.
     *
