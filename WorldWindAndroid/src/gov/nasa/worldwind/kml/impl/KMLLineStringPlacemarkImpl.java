...
/**
 * @author tag
 * @version $Id: KMLLineStringPlacemarkImpl.java 822 2012-09-28 03:16:15Z dcollins $
 */
public class KMLLineStringPlacemarkImpl extends Path implements KMLRenderable
{
    ...
    protected ShapeAttributes makeAttributesCurrent(String attrType)
    {
        ...
        if (!this.isHighlighted() || KMLUtil.isHighlightStyleState(lineSubStyle))
        {
            ...
            attrs.setEnableInterior(((KMLPolyStyle) fillSubStyle).isFill());
            attrs.setEnableOutline(((KMLPolyStyle) fillSubStyle).isOutline());
        }
    ...
    protected ShapeAttributes getInitialAttributes(String attrType)
    {
        ...
        {
            attrs.setInteriorColor(Color.pink());
            attrs.setOutlineColor(Color.red());
        }
        else
        {
            attrs.setInteriorColor(Color.lightGray());
