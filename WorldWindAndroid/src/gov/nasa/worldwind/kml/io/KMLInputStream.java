...
public class KMLInputStream implements KMLDoc {
	 ...
	 *            the KML stream.
	 * @param uri
	 *            the URI of this KML document. This URI is used to resolve relative references. May be {@code null}.
	 * @throws IllegalArgumentException
	 *             if the specified input stream is null.
	 * @throws java.io.IOException
	 *             if an error occurs while attempting to read from the stream.
	 */
	...
	public String getSupportFilePath(String path) {
		...
		if (this.uri != null) {
			...
			if (remoteFile != null) return remoteFile.toString();
		}
		return null;
	}
}
