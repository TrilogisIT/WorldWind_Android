...
public class JarRetriever extends URLRetriever {
	...
	protected ByteBuffer doRead(URLConnection connection) throws Exception {
		...
		String msg = Logging.getMessage("HTTPRetriever.ResponseInfo", this.responseCode, connection.getContentLength(), contentType != null ? contentType
				: "content type not returned", connection.getURL());
		Logging.verbose(msg);
