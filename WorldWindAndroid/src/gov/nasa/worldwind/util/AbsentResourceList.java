...
public class AbsentResourceList {
	 ...
	 * 
	 * @param maxTries
	 *            the number of max tries. Must be greater than 0.
	 * @param minCheckInterval
	 *            the check interval. Must be greater than or equal to 0.
	 * @throws IllegalArgumentException
	 *             if max-tries is less than 1 or the minimum check interval is less than 0.
	 */
	 ...
	 * @param minCheckInterval
	 *            the check interval. Must be greater than or equal to 0.
	 * @param tryAgainInterval
	 *            the try-again interval. Must be greater than or equal to 0.
	 * @throws IllegalArgumentException
	 ...
	 * 
	 * @param checkInterval
	 *            the check checkInterval. Must be greater than or equal to 0.
	 * @throws IllegalArgumentException
	 *             if the minimum check checkInterval is less than 0.
	 */
	 ...
	 * 
	 * @param retryInterval
	 *            the try-again retryInterval. Must be greater than or equal to 0.
	 * @throws IllegalArgumentException
	 *             if the try-again retryInterval is less than 0.
	 */
	 ...
	 * 
	 * @param resourceID
	 *            the resource to mark as absent.
	 */
	...
	synchronized public void markResourceAbsent(String resourceID) {
		...
		AbsentResourceEntry entry = this.possiblyAbsent.get(resourceID);
		if (entry == null) this.possiblyAbsent.put(resourceID, entry = new AbsentResourceEntry());
	 ...
	 * 
	 * @param resourceID
	 *            the resource to mark as not absent.
	 */
