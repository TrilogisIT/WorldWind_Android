 ...
 * <ul>
 * <li>Layer configuration documents</li>
 * <li>ElevationModel configuration documents</li>
 * <li>Installed data configuration documents</li>
 * <li>World Wind .NET LevelSet documents</li>
 * </ul>
 * 
 * @author dcollins
...
public class DataConfigurationFilter implements java.io.FileFilter, FileStoreFilter {
	...
	/**
	 * Returns true if the specified file can be opened as an XML document, and calling {@link #accept(org.w3c.dom.Document)} returns true.
	 * 
	 * @param file
	...
	public boolean accept(java.io.File file) {
		...
		if (!this.acceptFilePath(file.getPath())) return false;
	...
	/**
	 * Returns true if the specified {@link java.net.URL} can be opened as an XML document, and calling {@link #accept(org.w3c.dom.Document)} returns true.
	 * 
	 * @param url
	 *            the URL in question.
	...
	/**
	 * Returns true if the specified {@link java.io.InputStream} can be opened as an XML document, and calling {@link #accept(org.w3c.dom.Document)} returns
	 * true.
	 * 
	 * @param inputStream
	...
	/**
	 * Returns true if the specified file store path can be opened as an XML document, and calling {@link #accept(org.w3c.dom.Document)} returns true.
	 * 
	 * @param fileStore
	 *            the file store containing the named file path.
	 * @param fileName
	 *            the named file path in question.
	 * @return true if the file name should be accepted; false otherwise.
	 * @throws IllegalArgumentException
	 *             if either the file store or the file name are null.
	 */
	public boolean accept(FileStore fileStore, String fileName) {
		...
		if (file != null) return this.accept(file);
